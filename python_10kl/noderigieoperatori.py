#vienkārsi piepildīt list ar elementiem 
...
#izmanto zip - sapako vairakus lis ka tuple
    my_list = [1,2,3]
    my_list2 = ["a","b","c"]
...
#salikt visu vienā list
print(list(zip(my_list2,my_list,my_list3)))


#izmanto in, lai noskaidrotu vai objekts ir atrodams meklētais
print("x" in [1,2,3])
print(2 in [1,2,3])
print("a" in "pasaule")
